const iconEdit =
    <svg className="bi bi-pencil-square" width="1em" height="1em" viewBox="0 0 16 16" fill="orange" xmlns="http://www.w3.org/2000/svg">
        <path
...
const iconDelete =
    <svg className="bi bi-trash" width="1em" height="1em" viewBox="0 0 16 16" fill="red" xmlns="http://www.w3.org/2000/svg">
        <path
...
export {iconEdit, iconDelete, iconPersonSquare};