          ...
          <aside className="bg-primary align-items-center text-center mx-auto" id="filter-sidebar" style={{ minHeight: '100vh', minWidth: '100%' }}>
            ...
            <div>
              <OverlayTrigger placement="right" overlay={<Tooltip id="image-tooltip-profile">Profile</Tooltip>}>
                <Image className="align-bottom mt-4 p-0" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg" roundedCircle style={{ width: '50%', height: 'auto' }}></Image>
              </OverlayTrigger>
            </div>
            <div><OverlayTrigger placement="right" overlay={<Tooltip id="button-tooltip-options">Options</Tooltip>}>
              <Button id="options" className="align-bottom mb-auto p-0" variant="link"><i className="bi bi-three-dots text-light" aria-label="Options" style={{ fontSize: '1.5rem' }}></i></Button>
            </OverlayTrigger>
            </div>
          </aside>
        </Col>
